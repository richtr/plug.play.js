 ...
 */
 !function(k,j){function q(a){return a.replace(/^([+-])?(\d+).?(\d*)[eE]([-+]?\d+)$/,function(a,c,d,g,e){var f=0>+e,i=d.length+ +e,a=(f?d:g).length,e=(e=Math.abs(e))>=a?e-a+f:0,a=Array(e+1).join("0"),d=d+g;return(c||"")+(f?d=a+d:d+=a).substr(0,i+=f?a.length:0)+(i<d.length?"."+d.substr(i):"")})}var n=k.RSVP={},h=k.MutationObserver||k.WebKitMutationObserver;if("undefined"!==typeof process)h=function(a,b){process.nextTick(function(){a.call(b)})};else if(h){var u=[],h=new h(function(){var a=u.slice();
 u=[];a.forEach(function(a){a[0].call(a[1])})}),y=k.document.createElement("div");h.observe(y,{attributes:!0});h=function(a,b){u.push([a,b]);y.setAttribute("drainQueue","drainQueue")}}else h=function(a,b){k.setTimeout(function(){a.call(b)},1)};n.async=h;var E=n.Event=function(a,b){this.type=a;for(var c in b)b.hasOwnProperty(c)&&(this[c]=b[c])},z=function(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c][0]===b)return c;return-1},v=function(a){var b=a._promiseCallbacks;b||(b=a._promiseCallbacks={});return b},
 h=n.EventTarget={mixin:function(a){a.on=this.on;a.off=this.off;a.trigger=this.trigger;return a},on:function(a,b,c){var d=v(this),g,c=c||this;(g=d[a])||(g=d[a]=[]);-1===z(g,b)&&g.push([b,c])},off:function(a,b){var c=v(this);if(b){var c=c[a],d=z(c,b);-1!==d&&c.splice(d,1)}else c[a]=[]},trigger:function(a,b){var c,d,g,e;if(c=v(this)[a])for(var f=0,i=c.length;f<i;f++)d=c[f],g=d[0],d=d[1],"object"!==typeof b&&(b={detail:b}),e=new E(a,b),g.call(d,e)}},r=n.Promise=function(){this.on("promise:resolved",function(a){this.trigger("success",
 {detail:a.detail})},this);this.on("promise:failed",function(a){this.trigger("error",{detail:a.detail})},this)},A=function(){},B=function(a,b,c,d){var g,e;if(c)try{g=c(d.detail)}catch(f){e=f}else g=d.detail;if(g instanceof r)g.then(function(a){b.resolve(a)},function(a){b.reject(a)});else if(c&&g)b.resolve(g);else if(e)b.reject(e);else b[a](g)};r.prototype={then:function(a,b){var c=new r;this.on("promise:resolved",function(b){B("resolve",c,a,b)});this.on("promise:failed",function(a){B("reject",c,b,
 a)});return c},resolve:function(a){n.async(function(){this.trigger("promise:resolved",{detail:a});this.isResolved=a},this);this.reject=this.resolve=A},reject:function(a){n.async(function(){this.trigger("promise:failed",{detail:a});this.isRejected=a},this);this.reject=this.resolve=A}};h.mixin(r.prototype);var f=function(a,b){this.options=b||{debug:!1};this.svc=a;this.action=function(){};if(!this.svc||!(this.svc instanceof NetworkService))return this.debugLog("First argument provided in constructor MUST be a valid NetworkService object"),
 this;if(!this.svc.type||0!==this.svc.type.indexOf("upnp:"))return this.debugLog("First argument provided in constructor MUST be a _UPnP_ NetworkService object"),this;this.svcType=this.svc.type.replace("upnp:","");var c=this;this.action=function(a,b,e){var f=new RSVP.Promise;!e&&"[object Function]"==Object.prototype.toString.call(b)&&(e=b,b={});if(!e||"[object Function]"!==Object.prototype.toString.call(e))e=function(){};var i=this.createRequest(this.svcType,a,b);this.sendRequest(this.svcType,a,this.svc.url,
 i,function(i,h){null!==i?(e.apply(j,[i,null]),f.reject(i)):c.handleResponse(a,h.responseXML||"",b,function(a,b){e.apply(j,[a,b]);null!==a?f.reject(a):f.resolve(b)})});return f}};f.prototype.constructor=f;f.prototype.requestTemplate='<?xml version="1.0" encoding="utf-8"?>\n<s:Envelope s:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/" xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">\n\t<s:Body>\n\t\t<u:{ACTION_NAME} xmlns:u="{ACTION_TYPE}">\n{ACTION_VARS}\t\t</u:{ACTION_NAME}>\n\t</s:Body>\n</s:Envelope>\n';
 ...
 b)},bin_hex:function(a,b,c){if(a===j||null===a||""===a||"NaN"==a+""||a instanceof RegExp)a="";if(!0===a||!1===a)a=!0===a?"1":"0";if(c)for(var a=(a+"").toUpperCase().replace(/s\/[^0-9A-Z]\/\/g/),d="",g="",c=0;c<a.length;c++)g+=a.charAt(c),2==g.length&&(g=parseInt(g,16),g=g.toString(16),1==g.length&&(g="0"+g),g="%"+g,g=unescape(g),d+=g,g="");else{a+="";d="";for(c=0;c<a.length;c++){var e,g=a.charCodeAt(c)&255;e="";for(var m=!0,i=32;0<i;){var i=i-4,h=g>>i&15;if(!m||0!=h)m=!1,e+=C[h]}g=e=""==e?"0":e;for(e=
 ...
 this.responseText)):(f.debugLog("[SUCCESS-RESPONSE] "+this.responseText),g.apply(this,[null,this])),t.release(e))};e.send(d)}catch(i){g.apply(j,[new x(i),null])}return this};f.prototype.handleResponse=function(a,b,c,d){var c=this.formatParameters(c),c=c.response,f={},e=b.getElementsByTagName?b.getElementsByTagName(a+"Response"):null;if(null===e||0>=e.length)e=b.getElementsByTagName?b.getElementsByTagName("u:"+a+"Response"):null;if(null!==e&&0<e.length&&(a=e[0].childNodes)&&0<a.length){b=0;for(e=a.length;b<
 e;b++){var h=a[b].nodeName,i=a[b].firstChild?s((a[b].firstChild.nodeValue+"").replace(/&quot;/g,'"').replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&amp;/g,"&")):null;if(c[h]&&c[h].type!==j&&null!==c[h].type){var k=this.types[c[h].type];k&&(i=k(i,c[h].allowedValueList||null,!0))}f[h]=i!==j&&null!==i?i:""}}d.apply(j,[null,{data:f}]);return this};f.prototype.formatParameter=function(a){var b={};a.type!==j||a.value!==j||a.allowedValueList!==j?(b=a,a.allowedValueList!==j&&"array"!==typeof a.allowedValueList&&
 (a.allowedValueList=[])):b={value:a};b.type!==j&&null!==b.type&&(this.types[b.type+""]||delete b.type);return b};f.prototype.formatParameters=function(a){if(a===j||null===a)a={};a.request||(a.request={});a.response||(a.response={});for(var b in a)if("request"===b||"response"===b)for(var c in a[b])a[b][c]=this.formatParameter(a[b][c]);else a.request[b]=this.formatParameter(a[b]),delete a[b];return a};f.prototype.checkAllowedValues=function(a,b){if(a&&b&&"[object Array]"==Object.prototype.toString.call(b)){for(var c=
 !1,d=0,f=b.length;d<f;d++)if(a==b[d]){c=!0;break}if(!c)return""}return a};f.prototype.debugLog=function(a,b){if(this.options&&this.options.debug)console[b||"log"]("Plug.UPnP: "+a)};var t,D=[];t={get:function(){return D.pop()||new XMLHttpRequest},release:function(a){a.onreadystatechange=function(){};D.push(a)}};var x=function(a){return{description:a}},p={};for(l=0;64>l;l++)p["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(l)]=l;var H=function(a){var b=[0,2,1][a.length%3],
 a=a.charCodeAt(0)<<16|(1<a.length?a.charCodeAt(1):0)<<8|(2<a.length?a.charCodeAt(2):0);return["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(a>>>18),"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(a>>>12&63),2<=b?"=":"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(a>>>6&63),1<=b?"=":"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(a&63)].join("")},I=function(a){var b=a.length,c=b%4,a=(0<b?p[a.charAt(0)]<<
 18:0)|(1<b?p[a.charAt(1)]<<12:0)|(2<b?p[a.charAt(2)]<<6:0)|(3<b?p[a.charAt(3)]:0),a=[String.fromCharCode(a>>>16),String.fromCharCode(a>>>8&255),String.fromCharCode(a&255)];a.length-=[0,0,2,1][c];return a.join("")},G=k.btoa||function(a){return a.replace(/[\s\S]{1,3}/g,H)},F=k.atob||function(a){return a.replace(/[\s\S]{1,4}/g,I)},C;l={};for(h=0;16>h;h++)l[h]="0123456789abcdef".charAt(h);C=l;var s=function(a){return String.prototype.trim?a.trim():a.replace(/^\s+|\s+$/g,"")},w=function(a){return a.replace(/&/g,
 "&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")};k.Plug||(k.Plug={});k.Plug.UPnP||(k.Plug.UPnP=f)}(this);